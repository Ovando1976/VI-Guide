import { moravianBatchEvents } from "../../src/data/historyGraph/index.ts";

const events = moravianBatchEvents.filter(Boolean);
const failures = [];
...
console.log("Moravian Archives event verification");
console.log("====================================");
...
console.log("All Moravian Archives batch events passed structural verification.");
