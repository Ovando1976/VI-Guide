...
export const FERRY_ROUTES: FerryRoute[] = [
  ...
  },
  {
    ...
    durationMinutes: 55,
    departures: ["5:00 PM"],
    operatingDays: "Published daily departure except Tuesday and Wednesday",
    serviceDays: DAILY,
    fareNote: "International fares, taxes and port fees vary by operator; verify before booking.",
    checkInMinutes: 60,
    sourceLabel: "British Virgin Islands Tourist Board",
    sourceUrl: BVI_TOURISM,
    operatorName: "Aquatic Rentals Ferry Service",
    terminalName: "Urman V. Fredericks Marine Terminal",
    requiresPassport: true,
    goodToKnow: ["A valid passport is required.", "The published 5 PM service does not operate Tuesday or Wednesday.", "International taxes and port fees may be separate."],
  },
  {
    id: "road-town-red-hook",
    from: "road-town",
    to: "red-hook",
    fromLabel: "Road Town, Tortola",
    toLabel: "Red Hook, St. Thomas",
    serviceLabel: "International passenger ferry",
    durationMinutes: 55,
    departures: ["6:45 AM", "7:45 AM"],
    operatingDays: "Published daily departures; selected service except Tuesday and Wednesday",
    serviceDays: DAILY,
    fareNote: "International fares, taxes and port fees vary by operator; verify before booking.",
    checkInMinutes: 60,
    sourceLabel: "British Virgin Islands Tourist Board",
    ...
    terminalName: "Road Town Ferry Terminal",
    requiresPassport: true,
    goodToKnow: ["A valid passport is required.", "Selected published service does not operate Tuesday or Wednesday.", "BVI departure taxes and other fees may be separate."],
  },
  {
