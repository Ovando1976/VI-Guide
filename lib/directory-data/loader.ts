    ...
    records
      ...
      .map((record) =>
        Object.freeze({
          ...
          accessibility: Object.freeze([...record.accessibility]),
...
function parseDirectoryRecord(
  ...
  return {
    ...
    reservationUrl: optionalString(record.reservationUrl),
    ...
    operatingStatus: optionalString(record.operatingStatus) as DirectoryRecord["operatingStatus"],
    verificationLevel: optionalString(record.verificationLevel) as DirectoryRecord["verificationLevel"],
    hours: stringArray(record.hours),
    amenities: stringArray(record.amenities),
    accessibility: stringArray(record.accessibility),
