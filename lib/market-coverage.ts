...
export const MARKET_COVERAGE_SOURCES: readonly CoverageSource[] = [
  ...
  {
    id: "visit-usvi-kiteboarding-vi",
    label: "Visit USVI Kiteboarding VI",
    url: "https://www.visitusvi.com/listing/st-thomas/5390/kiteboarding-vi-kitesurfing-wing-foiling-lessons/",
    inventory: "activities",
    scope: "Current St. Thomas kiteboarding, kitesurfing, and wing-foiling operator coverage",
    authority: "destination",
    reviewCadenceDays: 30,
  },
  {
    ...
    inventory: "activities",
    scope: "Current named high-adventure operators including St. Croix kiteboarding instruction",
    authority: "destination",
    reviewCadenceDays: 30,
  },
  {
    ...
    inventory: "activities",
    scope: "Current visitor-tour coverage for Cruzan Rum, Sion Farm Distillery, and other USVI spirit producers",
    authority: "destination",
    reviewCadenceDays: 30,
  },
  {
