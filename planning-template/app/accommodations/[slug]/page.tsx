    ...
    <main className="stay-detail min-h-screen bg-[#f8f4ea] pb-36 text-[#043331]">
      <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="mt-7 grid gap-7 lg:grid-cols-[minmax(0,1.15fr)_minmax(330px,.85fr)] lg:items-start">
          ...
          <div className="lg:sticky lg:top-6"><StayActionCard id={item.slug} slug={item.slug} name={item.name} website={item.website} island={islandName} islandCode={item.island} location={item.location} image={item.heroImage} description={item.description} /></div>
        </div>
      </div>
    </main>
  );
