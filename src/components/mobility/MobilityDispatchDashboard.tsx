...
import {
  subscribeRecentMobilityTripRequests,
  type SavedMobilityTripRequest,
...
export default function MobilityDispatchDashboard() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeRecentMobilityTripRequests({
      limitCount: 50,
      onData: (nextRequests) => {
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-base font-medium leading-8 text-slate-300 sm:text-lg">
                Live read-only view of submitted Mobility trip requests. This
                does not assign drivers, update trips, or modify dispatch state.
              </p>
            </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-semibold leading-6">
                    This usually means the current user is not signed in as an
                    admin, or the Firestore read rule has not been deployed.
                  </p>
                </div>
              </div>
            </div>
