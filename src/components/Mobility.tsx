        ...
        <div className="bg-[#020617] px-6 py-10 text-white sm:px-10 lg:px-12">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5">
              ...
              <a
                href="/admin/mobility"
                className="mt-5 block rounded-2xl bg-amber-300 px-5 py-4 text-center text-sm font-black text-slate-950 shadow-lg shadow-amber-950/20 transition hover:-translate-y-0.5 hover:bg-amber-200"
              >
                Open dispatch board
              </a>
            </div>
