                  ...
                  <Link key={label} href={href} className="group relative flex min-h-[190px] items-end overflow-hidden rounded-[24px] border border-white/12 bg-[#032f2d] p-4 transition hover:-translate-y-0.5 hover:border-[#f5c451]/60">
                    ...
                    <span className="relative flex w-full items-end gap-3">
                      ...
                      <span className="min-w-0 pb-0.5">
                        <span className="block text-[8px] font-black uppercase tracking-[.16em] text-[#73e3d9]">One-tap idea</span>
                        <span className="mt-1 block text-sm font-black text-white">{label}</span>
                        <span className="mt-1 block text-[10px] font-semibold leading-4 text-white/60">{copy.detail}</span>
                        <span className="mt-2 inline-flex items-center gap-1.5 text-[8px] font-black uppercase tracking-[.14em] text-[#f5c451]">{copy.cta} <ArrowRight size={12} /></span>
                      </span>
                    </span>
                  </Link>
                );
