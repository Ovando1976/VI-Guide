...
const INTENTS = [
  ...
  { id: "cruise-passenger", label: "Cruise passenger", detail: "Build a port-day plan that gets you back on time.", href: "/cruise-day-planner", icon: Ship, image: "/images/usvi-harbor-hero.jpg", alt: "Charlotte Amalie harbor and cruise port on St. Thomas" },
