  ...
  return (
    <section className="mt-6 rounded-[30px] border border-teal-200 bg-white p-5 shadow-sm sm:p-6">
      <div className="flex items-start gap-3">
        ...
        <div><p className="text-[9px] font-black uppercase tracking-[.17em] text-teal-700">Make USVI Explorer fit you</p><h2 className="mt-1 text-2xl font-black tracking-[-.04em]">What should this trip feel like?</h2><p className="mt-1 text-sm font-semibold text-slate-500">These preferences stay on this device and improve planning. Anonymous product learning is optional.</p></div>
      </div>
      <form onSubmit={submit} className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <label className="flex items-start gap-3 rounded-2xl bg-[#f8f4ea] p-4 text-xs font-semibold leading-5 text-slate-600 sm:col-span-2 lg:col-span-3"><input type="checkbox" checked={consent} onChange={(event) => setConsent(event.target.checked)} className="mt-0.5 h-4 w-4 accent-teal-700" /><span>Share anonymous feature-use and outcome data to improve USVI Explorer. No precise location, payment details, addresses, contact information, or full conversations.</span></label>
