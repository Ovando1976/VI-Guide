    ...
    <section className="mt-8 rounded-[32px] border border-[#0b5b57]/15 bg-[#f8f4ea] p-5 shadow-[0_22px_70px_rgba(4,51,49,.08)] md:p-8">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-600">USVI Explorer turns the ferry into one connected traveler journey instead of making you plan each transfer separately.</p>
        </div>
