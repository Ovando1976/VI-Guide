    ...
    <section className="mx-auto max-w-7xl px-4 pt-10 sm:px-7 lg:px-10 lg:pt-14" aria-labelledby="rental-start-title">
      <div className="rounded-[32px] border border-[#d5e4df] bg-[#fffdf8] p-5 shadow-[0_16px_45px_rgba(3,47,45,.07)] sm:p-7">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {STARTS.map(({ label, detail, icon: Icon, href }) => (
            <Link key={label} href={href} className="group rounded-[24px] border border-[#dce7e4] bg-white p-4 transition hover:-translate-y-0.5 hover:border-[#aad7d0] hover:shadow-[0_14px_30px_rgba(4,51,49,.09)]">
              <span className="grid h-10 w-10 place-items-center rounded-2xl bg-[#eaf8f5] text-[#0f766e]"><Icon className="h-5 w-5" /></span>
              <strong className="mt-4 block text-base font-black text-[#032f2d]">{label}</strong>
