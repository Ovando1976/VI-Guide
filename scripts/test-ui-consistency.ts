...
const commerceBookingExperience = source("components/booking/commerce-booking-experience.tsx");
const commerceBookingRoute = source("app/api/commerce-bookings/route.ts");
const merchantBookingRoute = source("app/api/merchant-bookings/[bookingId]/route.ts");
...
assert.match(travelProposalDesk, /Booking operations/);
...
assert.match(travelProposalRoute, /proposalTravelers/);
...
assert.match(sharedTrip, /buildTravelProposalBookingHref/);
assert.match(sharedTrip, /Request booking/);
assert.match(commerceBookingExperience, /proposalShareId/);
assert.match(commerceBookingExperience, /From Travel Advisor proposal/);
assert.match(commerceBookingRoute, /vi-guide-travel-proposal/);
assert.match(commerceBookingRoute, /booking_request_created/);
assert.match(commerceBookingRoute, /latestCommerceBookingReference/);
