...
const homeFerry = source("components/home/home-ferry-intelligence.tsx");
...
assert.match(homePage, /Your island command center/);
assert.match(homePage, /Where do you want to go or what do you want to do\?/);
assert.match(homePage, /Recommended for you/);
assert.match(homePage, /Today’s plan/);
assert.match(homePage, /aria-label="Mobile navigation"/);
assert.match(homePage, /AI Concierge/);
assert.match(homePage, /HomeIslandDayPreview/);
assert.doesNotMatch(homePage, /Good morning\./);
assert.doesNotMatch(homePage, /rating:/);
...
assert.match(homeLiveStatus, /Know what is published before you move\./);
assert.match(homeLiveStatus, /Full ferry board/);
...
assert.doesNotMatch(homeLiveStatus, /Start early for the calmest water/);
assert.doesNotMatch(homeLiveStatus, /images\/beaches\/st-thomas\/magens-bay-1\.jpg/);
assert.match(homeFerry, /Published ferry intelligence/);
assert.match(homeFerry, /Operating status is not live/);
assert.match(homeFerry, /isScheduleSuppressed/);
assert.match(homeFerry, /getNextFerryDeparture/);
assert.match(homeFerry, /route\.sourceUrl/);
assert.match(homeFerry, /America\/St_Thomas/);
assert.match(homeFerry, /Verify official source/);
...
assert.match(missionMode, /magens-bay-beach-1\.jpg/);
assert.doesNotMatch(missionMode, /images\/beaches\/st-thomas\/magens-bay-1\.jpg/);
