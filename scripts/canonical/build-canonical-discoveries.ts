...
writeFileSync(
  ...
  `// Auto-generated by scripts/canonical/build-canonical-discoveries.ts
...
export const canonicalDiscoveryMetadata = ${JSON.stringify(metadata, null, 2)} as const;

export const canonicalDiscoveries: CanonicalDiscovery[] = ${JSON.stringify(canonicalRecords, null, 2)};
`,
);
