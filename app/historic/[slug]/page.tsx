      ...
      <div className="mx-auto max-w-7xl space-y-7">
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="rounded-[30px] bg-[#e8f5f2] p-7">
            ...
            <Link href={`/?concierge=open&prompt=${encodeURIComponent(`Plan a historic day around ${site.name}`)}`} className="mt-6 inline-flex rounded-full bg-[#043331] px-5 py-3 text-[10px] font-black uppercase tracking-[.18em] text-white">Ask concierge</Link>
          </aside>
        </section>
      </div>
    </main>
