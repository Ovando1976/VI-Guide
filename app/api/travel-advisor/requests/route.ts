  ...
  try {
    ...
    const result = await db.runTransaction(async (transaction) => {
      ...
      const acknowledgement = normalizeBookingNotification({
        ...
        title: "Your USVI Explorer trip-planning request is in",
        message: `We received your USVI trip-planning request ${reference}. A USVI Explorer travel advisor can review the trip details you submitted while you continue building and saving ideas in My Trip. No reservation or price is confirmed until USVI Explorer or the relevant provider confirms it with you.`,
        href: "/planner",
        createdAt: travelRequest.submittedAt,
      });
      if (!acknowledgement) {
